...
import forest from '@/components/images/homeCarousel/forest.webp'
import HeroBanner from '@/components/modules/HeroBanner'
import Image from 'next/image'

const QueFaireDansLePerigordVert = () => {
  return (
    <div className='w-full'>
      ...
      >
        <Image
          alt='Paysage typique dans le Perigord Vert'
          src={forest}
          placeholder='blur'
          fill
          sizes='100vw'
...
export default QueFaireDansLePerigordVert
