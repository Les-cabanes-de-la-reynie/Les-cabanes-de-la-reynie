...
import forest from '@/components/images/homeCarousel/forest3.webp'
import HeroBanner from '@/components/modules/HeroBanner'
import Image from 'next/image'

const QueFaireDansLePerigordPourpre = () => {
  return (
    <div className='w-full'>
      ...
      >
        <Image
          alt='Paysage typique dans le Perigord Pourpre'
          src={forest}
          placeholder='blur'
          fill
          sizes='100vw'
...
export default QueFaireDansLePerigordPourpre
