  ...
  return (
    <li>
      ...
      >
        ...
        >
          <span className='relative inline-block w-full before:absolute before:inset-0 before:block before:-skew-y-[3deg] before:bg-primary before:transition-all group-hover:lg:before:-inset-10 group-hover:lg:before:bg-primary-dark'>
